...
java $JVM_OPTS $DSE_OPTS -Dlogback.configurationFile=logback-tools.xml $JAVA_AGENT -ea -Xmx1G -Xms1G -cp $CLASSPATH com.datastax.dse.demos.solr.SolrStress $* 2> exceptions.log
