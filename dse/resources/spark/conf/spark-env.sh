...
export SPARK_WORKER_DIR="/Users/crupib/dse/spark/worker"

export SPARK_LOCAL_DIRS="/Users/crupib/dse/spark/rdd"

# This is a base directory for Spark Worker logs. The actual log files will be placed under
# worker-0/, worker-1/, ... sub-directories - each for a single worker instance.
export SPARK_WORKER_LOG_DIR="/Users/crupib/dse/spark/worker"
